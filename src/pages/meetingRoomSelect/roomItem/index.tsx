...
function roomItem(props: propsType) {
  ...
  const TimeList = [
    ...
    '11', '11:30', '12', '12:30', '13', '13:30',
    '14', '14:30', '15', '15:30', '16', '16:30',
    '17', '17:30', '18', '18:30', '19', '19:30',
    '20', '20:30', '21', '21:30', '22', '22:30',
    '23'
  ]
  ...
  const TimeLineList = TimeList.map((_item, i) => {
    ...
    return (
      <RoomTimeLine
        ...
        type={type}
        isEnd={isEnd}
      ><View className="room-time-line-numb">{i%2===0?_item:''}</View></RoomTimeLine>
    )
  })
  ...
  return (
    <View className="room-item-box" onClick={goMeetingTime}>
      ...
      {/* end 会议卡片详情 */}
      {/* 时间区间 */}
        <View className="room-item-time-line">
          {TimeLineList}
        </View>
      {/* end 时间区间 */}
    </View>
